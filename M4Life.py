...
# Original Version by Adafruit: https://github.com/adafruit/Adafruit_Learning_System_Guides/blob/master/CircuitPython_RGBMatrix/life.py
...
# as often.
# Modified by CommieGIR to support MatrixPortal M4 and 32x16 RGB
displayio.release_displays()
